...
export default function NavBar() {
    ...
    const homeLink = role === "FREELANCER" ? "/Home_Freelancer" : "/home_client";
    const profile = role === "FREELANCER" ? "/Freelancer_profile" : "/Client_profile";
    const saved = role === "FREELANCER" ? "/SavedProjects" : "/SavedFreelancers";
